...
export namespace MessageBox {
    export function alert(message: string, title?: string, option?: IMessageBoxOption): Promise<any>;
    export function confirm(message: string, title?: string, option?: IMessageBoxOption): Promise<any>;
    export function prompt(message: string, title?: string, option?: IMessageBoxOption): Promise<{value: string, actions: any}>;
}
